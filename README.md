...
For the classification model, the Dow Jones Industrial Average accuracy scores ranged from 0.36 to 0.46, which indicated the model worked below average. For IBM accuracy scores ranged from 0.49 to 0.50, which indicated the model below average.
